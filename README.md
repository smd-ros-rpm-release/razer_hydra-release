...
## razer_hydra (indigo) - 0.2.1-0

The packages in the `razer_hydra` repository were released into the `indigo` distro by running `/usr/bin/bloom-release razer_hydra -t indigo -r indigo` on `Fri, 30 May 2014 02:39:31 -0000`

The `razer_hydra` package was released.

Version of package(s) in repository `razer_hydra`:
- rosdistro version: `0.0.13-2`
- old version: `0.0.13-2`
- new version: `0.2.1-0`
